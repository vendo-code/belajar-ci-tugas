...
<table class="table datatable">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="<?= base_url('ProdukCategory/delete/' . $kategori['id']) ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus data ini ?')">
                Hapus
            </a>
        </td>
    </tr>
...
<div class="modal fade" id="editModal-<?= $kategori['id'] ?>" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('ProdukCategory/edit/' . $kategori['id']) ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
